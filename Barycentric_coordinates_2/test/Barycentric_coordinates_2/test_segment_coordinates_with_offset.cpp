...
int main() {
  ...
  const Point_2 queries[6] = {
    Point_2( FT(2) / FT(5) ,  FT(1) / FT(3)),
    Point_2(1, -FT(1) / FT(3)),
    Point_2( FT(7) / FT(10),  FT(1) / FT(3)),
    Point_2(-FT(3) / FT(10), -FT(1) / FT(3)),
    Point_2( FT(6) / FT(5) ,  FT(1) / FT(3)),
    Point_2(0, -FT(1) / FT(3))
  };
  ...
  std::cout << "test_segment_coordinates_with_offset: PASSED" << std::endl;
  return EXIT_SUCCESS;
}
